...
<br />
<b>Message Search:</b> <form action="chatsearch.php" style="display: inline;"><input class="form-control" style="width: 150px;display: inline;" type="text" name="msg" id="msg" style="text-align:center;" placeholder="Message" value="<?php echo htmlentities($_GET['msg']); ?>"> <input class="btn btn-primary" type="submit" value="Go"></form>
<br />
<br />
Displaying results for "<?php echo htmlentities($_GET['msg']); ?>"
<br />
...
if(isset($_GET['msg']) && !empty($_GET['msg'])) {
	$msg = $_GET['msg'];
	$query = $db->prepare("SELECT * FROM `messages` WHERE Message LIKE :Msg ORDER BY ID DESC");
